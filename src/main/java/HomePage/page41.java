...
public class page41 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("<html>Avatar(With English Subtitle)<BR><BR>Duration : 2hr 13min<BR><BR>Genre : Action</html>");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("<Html>Movie Description <BR><BR>\"Avatar,\" a live action film with a new generation of special effects, takes us to a spectacular<BR> world beyond imagination, where a reluctant hero embarks on a journey of redemption <BR>and discovery as he leads an epic battle to save a civilization.<BR> </HTML>");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\HP\\AppData\\Roaming\\Microsoft\\Windows\\Network Shortcuts\\Avatar.jpg")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(page41.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
