...
public class page51 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("<html>Avengers(With English Subtitle)<BR><BR>Duration : 2hr 25min<BR><BR>Genre : Fiction</html>");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel6.setText("<Html>Movie Description <BR><BR>In college, Farhan and Raju form a great bond with Rancho due to<BR> his refreshing outlook. Years later, a bet gives<BR> them a chance to look for their long-lost friend whose existence <BR> seems rather elusive.</HTML>");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\HP\\AppData\\Roaming\\Microsoft\\Windows\\Network Shortcuts\\Avenger.jpg")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(page51.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
